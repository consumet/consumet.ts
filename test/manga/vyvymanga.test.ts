...
test('fetchChapterPages: returns filled page data when given a chapterId.', async () => {
  const data = await vyvymanga.fetchChapterPages('https://summonersky.com/rds/rdsd?data=cjUrTGRiT3Q0NDV3cWNvdjlFcVhScHpCUy9MZ0tXa21oSHR4c2VlbUZVUEx0ZitlQWFSMlF4dWJyMXAweU5UWFBJay9YaTc5WllUb0RWZy9JQnc5RGxPOWRXQk9CNHk1bmtwTVRxQnFaVzdEemxGdHVTSzlsTnh5ZzhMNXNqMlYrOGRLZWRVVVpVVW1UUFFZNHBqOXJBPT06OkLTY3JOCbyE7jUI78gGnHY%3D');
  expect(data).not.toEqual([]);
});