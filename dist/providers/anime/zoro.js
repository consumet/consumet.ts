...
(async () => {
    ...
    const sources = await zoro.fetchEpisodeSources('solo-leveling-season-2-arise-from-the-shadow-19413$episode$131394$dub', models_1.StreamingServers.VidCloud, models_1.SubOrSub.DUB);
    console.log(sources);
})();
