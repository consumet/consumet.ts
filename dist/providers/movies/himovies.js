            ...
            try {
                ...
                const servers = $('ul.nav > li')
                    ...
                    return {
                        ...
                        url: `${this.baseUrl}/${mediaId}.${$el.find('a').attr('data-id')}`.replace(urlPattern, replacement),
                    };
                })
                    .get();
                return servers;
        ...
        switch (server) {
            case models_1.StreamingServers.UpCloud:
                return {
                    ...
                    ...(await new extractors_1.VidCloud(this.proxyConfig, this.adapter).extract(serverUrl, this.baseUrl)),
                };
