...
class Libgen extends models_1.BookParser {
    constructor() {
                ...
                $(e.children).each((i, e) => {
                    ...
                    switch (i) {
                        ...
                        case 4:
                            ...
                            container.title = (0, utils_1.formatTitle)($(e).text());
        ...
        this.search = (query, maxResults) => __awaiter(this, void 0, void 0, function* () {
            ...
            for (let extension of this.extensions) {
                workingExtension = extension;
                page = yield get(`${this.baseUrl}${extension}/search.php?req=${query}&view=simple&res=${maxResults ? (maxResults > 0 ? maxResults : 25) : 25}`);
                if (page.status <= 399)
                    break;
            }
            const $ = (0, cheerio_1.load)(page.data);
