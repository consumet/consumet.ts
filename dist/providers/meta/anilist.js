...
(() => __awaiter(void 0, void 0, void 0, function* () {
    const anilist = new Anilist(new zoro_1.default());
    const manga = yield anilist.fetchAnimeInfo('145545');
    const sources = yield anilist.fetchEpisodeSources(manga.episodes[0].id);
    console.log(sources);
}))();
