...
export declare const PROVIDERS_LIST: {
    ...
    LIGHT_NOVELS: never[];
    MOVIES: (import("../providers/movies/dramacool").default | import("../providers/movies/flixhq").default | import("../providers/movies/fmovies").default | import("../providers/movies/goku").default | import("../providers/movies/sflix").default | import("../providers/movies/himovies").default)[];
