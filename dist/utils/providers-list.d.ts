...
export declare const PROVIDERS_LIST: {
    ...
    MANGA: (import("../providers/manga/mangadex").default | import("../providers/manga/mangahere").default | import("../providers/manga/mangakakalot").default | import("../providers/manga/mangasee123").default | import("../providers/manga/mangapark").default | import("../providers/manga/mangapill").default)[];
