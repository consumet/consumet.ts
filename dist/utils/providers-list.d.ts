export declare const PROVIDERS_LIST: {
    ...
    MANGA: (import("../providers/manga/mangadex").default | import("../providers/manga/comick").default | import("../providers/manga/mangahere").default | import("../providers/manga/mangapill").default | import("../providers/manga/mangareader").default | import("../providers/manga/weebcentral").default | import("../providers/manga/mangakakalot").default | import("../providers/manga/comix").default)[];
    BOOKS: never[];
