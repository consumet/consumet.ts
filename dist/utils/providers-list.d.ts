...
export declare const PROVIDERS_LIST: {
    ANIME: (import("../providers/anime/gogoanime").default | import("../providers/anime/animepahe").default | import("../providers/anime/zoro").default | import("../providers/anime/anify").default | import("../providers/anime/crunchyroll").default | import("../providers/anime/bilibili").default | import("../providers/anime/marin").default | import("../providers/anime/animesaturn").default | import("../providers/anime/animekai").default | import("../providers/anime/kickassanime").default)[];
