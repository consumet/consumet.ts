...
class MegaUp extends models_1.VideoExtractor {
    constructor() {
        ...
        this.Decode = (n) => {
            n = __classPrivateFieldGet(this, _MegaUp_reverseIt, "f").call(this, __classPrivateFieldGet(this, _MegaUp_substitute, "f").call(this, __classPrivateFieldGet(this, _MegaUp_transform, "f").call(this, '5ygxI8hjLiuDQ0', __classPrivateFieldGet(this, _MegaUp_base64UrlDecode, "f").call(this, __classPrivateFieldGet(this, _MegaUp_transform, "f").call(this, 'z9cWnXuoDtx', __classPrivateFieldGet(this, _MegaUp_base64UrlDecode, "f").call(this, __classPrivateFieldGet(this, _MegaUp_substitute, "f").call(this, __classPrivateFieldGet(this, _MegaUp_reverseIt, "f").call(this, __classPrivateFieldGet(this, _MegaUp_substitute, "f").call(this, __classPrivateFieldGet(this, _MegaUp_transform, "f").call(this, 'EZnfG1IL6DF', __classPrivateFieldGet(this, _MegaUp_base64UrlDecode, "f").call(this, __classPrivateFieldGet(this, _MegaUp_reverseIt, "f").call(this, __classPrivateFieldGet(this, _MegaUp_base64UrlDecode, "f").call(this, (n = `${n}`))))), 'M2DCEbQmWOe', 'bEDCeOQ2mWM')), 'Lw7nfcTNz3FbWy', 'TFf37zywcNWnLb'))))), 'HK0TOgYzU1C', 'T1CHYU0OKgz'));
            return decodeURIComponent(n);
        };
