...
class Gogoanime extends AnimeParser {
  ...
  fetchDirectDownloadLink = async (downloadUrl: string): Promise<{ source: string | undefined; link: string | undefined }[]> => {
