...
class NewsFeed implements INewsFeed {
    constructor(public title: string, public id: string, public uploadedAt: string, public topics: Topics[], public preview: INewsFeed['preview'], public thumbnail: string, public url: string) {}
